        ...
        <>
            <div className="container" id="contact">
                ...
                <div class="row" id="contactWrapper" >
                    <div class="col-lg-4" id="contactBoxId">
                    <div id="contactIcon">
                            <div>
                                <i class="fas fa-map-marker"></i>
                            </div>
                            <div>
                                <p>20 Muti Street Johannesburg<br></br>
                        ...
                        <div id="contactIcon">
                            ...
                            <div>
                                <p>eiinford@thegreattable.com<br></br>
            ...
            <div className="container-fluid" id="footer">
                <div class="container text-center" id="footerBox">
                    <div class="row">
                        <div class="col" id="footerWrap">
                            <h4>About</h4>
                            <p>Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary
                        ...
                        <div class="col" id="footerWrap">
                            ...
                            <p>Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making
                                this the first true generator on the Internet. It uses a dictionary</p>

                        </div>
                        <div class="col" id="footerWrap2">
                            <h4>Quick links</h4>
                            <p>Our menu</p>
                            <p>Promotions</p>
                            <p>Booking</p>
